...
async function carregar_ingredientes() {
    ...
    itens.forEach(a => {
        ...
        const mat = mapa_materias.get(a.materia_prima_id)
        const nomeMat = mat ? mat.nome : `Matéria ${a.materia_prima_id}`
        div.innerHTML = `<div>#${a.id} - ${nomeMat} precisa ${qtd.toFixed(2)} ${a.unidade_medida}</div>
      <div>
